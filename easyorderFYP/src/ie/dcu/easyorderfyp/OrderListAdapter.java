...
public class OrderListAdapter extends ArrayAdapter<MenuItem> {
    ...
    /**
     * Constructor for a brand new order, calls the main constructor with a new list
     * @param context
    ...
    public OrderListAdapter(
    	...
    	this(context, layoutResourceId, new ArrayList<MenuItem>(), new ArrayList<Integer>());
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null)
        {
            ...
            holder.name = (TextView) row.findViewById(R.id.order_item_list_name);
            holder.quantity = (Button) row.findViewById(R.id.order_item_list_quantity);
            holder.price = (TextView) row.findViewById(R.id.order_item_list_price);
        ...
        holder.quantity.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				QuantityDialog.newInstance(quantities.get(tempPosition), tempPosition)
					.show(tempActivity.getSupportFragmentManager(), "QUAN_DIALOG");
			}
        });
